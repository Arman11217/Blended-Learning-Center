...
- **`DIAGRAMS.md`** - 📊 Class & ER Diagrams combined
- **`docs/class-diagram.md`** - Class diagram (OOP view)
- **`docs/er-diagram.md`** - ER diagram (Database view)
- **`export-diagrams-to-png.ps1`** - Script to export diagrams as PNG

---

## 📊 View System Diagrams

### Option 1: Quick View in VS Code
```
1. Open DIAGRAMS.md
2. Press Ctrl+Shift+V (Open Preview)
3. View both Class & ER diagrams together
```

### Option 2: Export to PNG for Printing
```powershell
# Run this command in project root
.\export-diagrams-to-png.ps1

# PNG files will be saved in: diagrams-export/
```
...
## 📁 Files in This Package (Original)
